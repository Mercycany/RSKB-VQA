...
model_id = "/mnt/data/models/llava-1.5-7b-hf"
pipe = pipeline("image-to-text", model=model_id, model_kwargs={"quantization_config": quantization_config})



input_json_path = "/home/qiaozijian/LLM_geo/image_QA.json"  
output_json_path = "/home/qiaozijian/LLM_geo/eval_geo_RAG_20llava7B.json"  
...
for item in tqdm(data):
    ...
    for item2 in item["Q&A"]:
        ...
        if random_number < 20:
            ...
            Please answer my questions based on the image. Answers should be concise and accurate. Next is reference information:{Reference}.
            If you don't know, you need to answer "sorry, I don't know."
            Next is the question:{question}\nASSISTANT:
            """
        else:
            prompt = f"""USER: <image>\nYou are a smart remote sensing image recognition expert. " 
            Please answer my questions based on the image. Answers should be concise and accurate.
            If you don't know, you need to answer "sorry, I don't know."
            Next is the question:{question}\nASSISTANT:
            """
        max_new_tokens = 400
